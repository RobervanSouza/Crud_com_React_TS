  ...
  static Initialize(): void {
    createServer({
      ...
      routes() {
        ...
        this.post("/jogos", GamesController.CreateGame);

        this.get("/jogos", GamesController.GetGames);

        this.get("/jogos/:categoryName", GamesController.GetGameByCategoryName);

        this.get("/jogos/:idGame", GamesController.GetGameById);

        this.patch("/jogos/:idGame", GamesController.UpdateGameById);

        this.del("/jogos/:idGame", GamesController.DeleteGame);
      },
    });
  }
}
